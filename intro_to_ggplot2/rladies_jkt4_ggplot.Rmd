...
1. geom_point() --> for scatter plot
2. geom_bar()   --> for bar chart
3. geom_area()  --> for area chart
4. geom_line()  --> for line chart

There are many other types of geoms. You can explore it yourself on [ggplot cheatsheet](https://rstudio.com/wp-content/uploads/2015/03/ggplot2-cheatsheet.pdf).  
