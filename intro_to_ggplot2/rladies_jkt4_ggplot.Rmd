...
1. data
2. aesthetic  --> aes()  --> x-axis, y-axis, colour, size, shape, etc
3. geometry   --> geom_* --> point, line, bar, histogram, boxplot, etc. 
4. theme (*optional*)      --> theme()
5. facets (*optional*)  --> columns, rows
6. coordinates (*optional*) --> cartesian, fixed, polar, limits. 
...
You can also explore it yourself on [ggplot cheatsheet](https://rstudio.com/wp-content/uploads/2015/03/ggplot2-cheatsheet.pdf).  
